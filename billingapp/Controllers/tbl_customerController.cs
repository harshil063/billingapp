...
namespace billingapp.Controllers
{
    public class tbl_customerController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "cust_id,cust_name,cust_email,cust_contact")] tbl_customer tbl_customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "cust_id,cust_name,cust_email,cust_contact")] tbl_customer tbl_customer)
        {
            if (ModelState.IsValid)
            {
